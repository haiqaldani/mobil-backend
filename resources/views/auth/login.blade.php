        ...
        <div class="flex flex-row px-5 py-5 mx-15 space-x-5 justify-around bg-gray-50">
            ...
            <div class="flex flex-col w-80 bg-white rounded-sm">
                <form class="mx-5 my-3 space-y-3" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input id="email" type="email"
                                class="w-full px-2 py-2 border border-blue-400 focus:outline-none  focus:border-black  @error('email') is-invalid @enderror"
                    ...
                    <div class="form-group ">
                        <div class="flex flex-col space-y-2">
                            ...
                            @if(Route::has('password.request'))
                                <a class="hover:text-blue-600 text-sm" href="{{ route('password.request') }}">
                    ...
                    <div class="form-group ">
                        <div class="flex flex-col space-y-2">
                            <a class="text-center rounded-sm text-white py-2 bg-yellow-400 hover:bg-yellow-500" href="{{ route('register') }}">
                                Register
                            </a>
                        </div>
                    </div>
