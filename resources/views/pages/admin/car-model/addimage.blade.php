    ...
    <div class="container-fluid">
        ...
        <div class="card shadow">
            <div class="card-header py-3 justify-content-between">
                <h3 class="m-0 font-weight-bold text-primary">Tambah Gallery {{ $item->model }}</h3>
            </div>
            <div class="card-body">
                <!-- Content Row -->
                @if ($errors->any())
                ...
                @endif
                <form action="{{ route('car-gallery.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    {{-- <div class="form-group"> --}}
                    <input type="hidden" class="form-control" name="car_model_id" placeholder="car_model_id"
                        value="{{ $item->id }}">
                    {{-- </div> --}}
                    <div class="form-group">
