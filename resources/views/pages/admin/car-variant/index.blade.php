            ...
            <div class="card-header py-3 justify-content-between">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h3 class="m-0 font-weight-bold text-primary text-2xl">Varian Mobil</h3>
                      <a href="{{ route('car-variant.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                      ...
                      @forelse($items as $item)
                          <tr>
                              ...
                              <td>
                                  ...
                                  <form action="{{ route('car-variant.destroy', $item->id) }}" method="post" class="d-inline">
                                      @csrf
                                      @method('delete')
