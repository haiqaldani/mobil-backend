            ...
            <div class="card-body">
                <form action="{{ route('car.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="edition" placeholder="Edisi" value="{{ old('edition') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="kilometers" placeholder="Kilometer" value="{{ old('kilometers') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="color" placeholder="Warna Mobil" value="{{ old('color') }}">
                    </div>
                    <div class="form-group">
                        <label for="vehicle_features">Fitur Kendaraan</label>
                        <textarea name="vehicle_features" rows="10" class="d-block w-100 form-control">{{ old('vehicle_features') }}</textarea>
                    </div>
                    <div class="form-group">
