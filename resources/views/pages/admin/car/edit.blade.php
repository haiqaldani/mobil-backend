...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-header py-3 justify-content-between">
            <h3 class="m-0 font-weight-bold text-primary">Edit Mobil {{ $item->title }}</h3>
        </div>
        <div class="card-body">
            <!-- Content Row -->
            @if($errors->any())
            ...
            <form action="{{ route('car-type.update', $item->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="condition" required class="form-control">
                        <option value="{{ $item->condition }}">Pilih Kondisi</option>
                ...
                <div class="form-group">
                    ...
                    <textarea id="vehicle_features" name="vehicle_features"
                        rows="10">{{ $item->vehicle_features }}</textarea>
                </div>
                <div class="form-group">
