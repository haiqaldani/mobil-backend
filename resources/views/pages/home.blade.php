...
@section('content')
    ...
    <section class="section-search">
        <div class="container mb-10">
            <div class="border-transparent md:mx-20 mx-10 py-5 bg-blue-900 rounded-md">
                <h1 class="text-center font-bold font-sans text-white text-xl md:text-3xl">Temukan Mobil Baru dan Mobil Bekas Impian
                    Anda</h1>
    ...
    <section class="section-type">
        <div class="container mb-10">
            <div class="md:mx-20 mx-10">
                <h2 class="font-semibold md:text-left text-center text-xl md:text-2xl mb-3 md:mb-0">Lihat bedasarkan tipe</h2>
    ...
    <section class="section-list">
        <div class="container static mb-10">
            <div class="lg:mx-20 mx-10 ">
                <h2 class="md:text-left text-center text-xl md:text-2xl font-semibold">List rekomendasi</h2>
                <div class="grid md:grid-cols-3 lg:grid-cols-4 sm:grid-cols-2 gap-4 md:justify-items-stretch">
                    @foreach ($cars as $car)
